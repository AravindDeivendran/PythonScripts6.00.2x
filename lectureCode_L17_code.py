...
def fitData(fileName):
    ...
    estYVals = a*xVals + b
    k = 1/a
    pylab.plot(xVals, estYVals, label = 'Linear fit, k = ' + str(round(k, 5)) + ', R2 = ' + str(round(rSquare(estYVals,yVals), 4)))

    pylab.legend(loc = 'best')

fitData('C:/Aravind/Learning/EdX/6.00.2x/Scripts/springData.txt')
pylab.show()
...
def fitData3(fileName):
    ...
    pylab.plot(xVals, estYVals, label = 'Linear fit, k = '
               + str(round(k, 5)) + ', R2 = ' + str(round(rSquare(estYVals,yVals), 4)))
    pylab.legend(loc = 'best')

fitData3('C:/Aravind/Learning/EdX/6.00.2x/Scripts/springData.txt')
pylab.show()
