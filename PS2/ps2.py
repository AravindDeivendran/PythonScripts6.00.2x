...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        if self.isPositionInRoom(pos):
            tileW = math.floor(pos.getX())
            tileH = math.floor(pos.getY())
            if not ((tileW, tileH) in self.cleanedTiles):
                self.cleanedTiles.append((tileW, tileH))
...
print  runSimulation(3, 1.0, 20, 20, 1, 30, SmartRobot)
